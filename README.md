...
dspc_bot_ctrl is a utility tool thats allows for improvement of content quality through adding wikipedia links to a word(eg: Geology) or group of words(Battle of the Bulge) if an article about a word or a group of words exists
